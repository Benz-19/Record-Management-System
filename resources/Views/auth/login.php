...
<head>
    ...
    <title>Login - LibriFlow RMS</title>
    ...
    <style>
        ...
        main {
            ...
            display: flex;
            align-items: center;
            /* Vertically center the login box */
            justify-content: center;
            /* Horizontally center the login box */
            padding: 40px 20px;
            /* Add some padding around the login box */
        }
...
<body>
    ...
    <!-- CoNTENT -->
    <?php require __DIR__ . '/../pages/loginContent.php'; ?>
